...
val_dataloader = DataLoader(val_dataset, batch_size=n_val // 2, shuffle=True, num_workers=args.num_gpus)
...
for v in range(len(val_datasets_names)):
    ...
    val_dataloader = DataLoader(val_dataset, batch_size=n_val_ood[v] // 2, shuffle=True, num_workers=args.num_gpus)
